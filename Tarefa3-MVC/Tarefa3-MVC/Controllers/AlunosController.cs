...
using Tarefa3_MVC.DAL;
using Tarefa3_MVC.Models;

namespace Tarefa3_MVC.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AlunoID,Nome,Idade,CursoID")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AlunoID,Nome,Idade,CursoID")] Aluno aluno)
        {
            if (ModelState.IsValid)
            {
